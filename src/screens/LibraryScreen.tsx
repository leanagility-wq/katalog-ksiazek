...
import { SORT_OPTIONS } from "@/config/bookUi";
import { appText } from "@/config/uiText";
import {
  ALL_GENRES_FILTER,
  ALL_LOCATIONS_FILTER,
  useLibraryCatalogController
} from "@/features/catalog/useLibraryCatalogController";
...
export function LibraryScreen({ onStartScan }: LibraryScreenProps) {
  const {
    ...
    handleDeleteBook,
    handleSubmitSearch,
    filterBooksWithoutLocation,
    filterBooksWithoutIsbn,
    filterBooksWithoutGenre,
            ...
            {isFiltersOpen ? (
              <View style={styles.filtersPanel}>
                <Text style={styles.genreFilterLabel}>
                  {appText.library.genreFilterLabel}
                </Text>
                <View style={styles.genreFilterRow}>
                  {genreOptions.map((option) => {
                    const isAllOption = option === ALL_GENRES_FILTER;
                    const label = isAllOption ? appText.library.genreFilterAll : option;
